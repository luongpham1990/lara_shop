            ...
            <div class="col-lg-12">
                <div class="panel panel-primary ">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="/admin/cata/edit/{{$cata->id}}" enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data"><input name="_token" type="hidden" value="fPdMAGRbTI5JL8qhYatebA965h6NuPPpAImtmrJk">
                            ...
                            <div class="form-group ">
                                <label for="title" class="col-sm-2 control-label">
                                    Catalog Name                        </label>
                                <div class="col-sm-5">
                                    <input class="form-control" placeholder="Category name" name="name" type="text" value="{{$cata->name}}">
                                </div>
                                <div class="col-sm-4">
                                </div>
                            </div>
